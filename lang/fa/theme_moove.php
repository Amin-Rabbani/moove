...
$string['prev_section'] = 'قسمت قبلی';
$string['next_section'] = 'قسمت بعدی';
$string['search_site'] = 'جستجو در سایت';
$string['search_forums'] = 'جستجو در انجمن ها';
$string['platform_access'] = 'دسترسی به پورتال';
$string['readmore'] = 'اطلاعات بیشتر';
$string['stayintouch'] = 'ارتباط با ما';
$string['madewitmoodle'] = 'با افتخار ساخته شده';
$string['madeby'] = 'ساخته شده';
$string['by'] = 'توسط';
...
$string['diskusage'] = 'میزان استفاده از دیسک';
$string['notcalculatedyet'] = 'محاسبه نشده';
$string['calculatediskusagetask'] = 'Task to calculate the disk usage';
$string['totalusers'] = 'کاربران فعال/غیرفعال';
$string['totalcourses'] = 'تمامی درس ها';
$string['onlineusers'] = 'کاربران آنلاین ';
$string['showhideblocks'] = 'نشان/پنهان کردن بلاک ها';
$string['prev_activity'] = 'فعالیت قبلی';
$string['next_activity'] = 'فعالیت بعدی';

// General settings tab.
$string['generalsettings'] = 'تنظیمات اصلی';
$string['logo'] = 'لوگو';
$string['logodesc'] = 'لوگو در سربرگ نمایش داده میشود';
$string['favicon'] = 'نشانک';
$string['favicondesc'] = 'نشانک خود را آپلود کنید. فایل باید پسوند .ico باشد';
$string['preset'] = 'قالب تم';
$string['preset_desc'] = 'با تغییر دادن قالب تم نمای سایت عوض میشود';
...
$string['loginbgimg_desc'] = 'پس زمینه شخصی سازی شده خود را آپلود کنید';
$string['brandcolor'] = 'رنگ برند';
$string['brandcolor_desc'] = 'رنگ برند';
$string['navbarheadercolor'] = ' رنگ سربرگ نوار ناوبری';
$string['navbarheadercolor_desc'] = 'رنگ سربرگ نوار ناوبری';
$string['navbarbg'] = 'رنگ نوار ناوبری';
$string['navbarbg_desc'] = 'رنگ نوار ناوبری سمت چپ';
$string['navbarbghover'] = 'رنگ معلق نوار ناوبری';
$string['navbarbghover_desc'] = 'رنگ نوار ناوبری سمت چپ';
$string['coursepresentation'] = 'ارائه درس';
...
$string['coursedefault'] = 'ارائه پیشفرض';
$string['coursecover'] = 'تصویر جلد';
$string['courselistview'] = 'فعال سازی نشان دادن لیست درس ها';
...
$string['disablefrontpageloginbox'] = 'غیرفعال سازی جعبه ورود در صفحه اول';
...
$string['bannerheading'] = 'سربرگ بنر';
$string['bannerheadingdesc'] = 'متن سربرگ بنر را وارد کنید';
$string['bannercontent'] = 'محتوا بنر';
$string['bannercontentdesc'] = 'متن محتوای بنر را وارد کنید';
$string['displaymarketingbox'] = 'نشان دادن جعبه مارکتینگ در صفحه اول';
...
$string['sponsorsimage'] = 'لوگو حامیان';
$string['sponsorsimagedesc'] = 'Add the sponsor\'s logo.';
$string['sponsorsurl'] = 'آدرس حامیان';
$string['sponsorsurldesc'] = 'Enter the sponsor\'s site URL';

$string['clientstitledefault'] = 'مشتری های ما';
$string['clientssubtitledefault'] = 'مشتری هایی که به ما اعتماد کرده اند';
$string['clientsfrontpage'] = 'فعالسازی نوار مشتری ها';
$string['clientsfrontpagedesc'] = 'If enabled, display a row with the clients logos with its urls.';
$string['clientstitle'] = 'تیتر مشتری ها';
$string['clientstitledesc'] = 'The header of the clients row.';
$string['clientssubtitle'] = 'زیر نویس مشتری ها';
$string['clientssubtitledesc'] = 'The subtitle of the clients row.';
$string['clientscount'] = 'تعداد مشتری ها';
...
$string['clientsimage'] = 'لوگو مشتری ها';
$string['clientsimagedesc'] = 'Add the client\'s logo.';
$string['clientsurl'] = 'آدرس مشتری ها';
$string['clientsurldesc'] = 'Enter the client\'s site URL';

// Footer settings tab.
$string['footersettings'] = 'پاورقی';
$string['getintouchcontent'] = 'محتوای تماس با ما';
$string['getintouchcontentdesc'] = 'محتوای تماس با ما را وارد کنید';
$string['website'] = 'آدرس سایت';
$string['websitedesc'] = 'آدرس سایت اصلی';
$string['mobile'] = 'موبایل';
$string['mobiledesc'] = 'شماره موبایل را وارد کنید';
$string['mail'] = 'ایمیل';
$string['maildesc'] = 'آدرس ایمیل را وارد کنید';
$string['facebook'] = 'آدرس فیسبوک';
$string['facebookdesc'] = 'آدرس فیسبوک خود را وارد کنید';
$string['twitter'] = 'آدرس توییتر';
$string['twitterdesc'] = 'آدرس توییتر خود را وارد کنید';
$string['linkedin'] = 'آدرس Linkedin';
$string['linkedindesc'] = 'آدرس Linkedin خود را وارد کنید';
$string['youtube'] = 'آدرس یوتیوب';
$string['youtubedesc'] = 'آدرس یوتیوب خود را وارد کنید';
$string['instagram'] = 'آدرس اینستاگرام';
$string['instagramdesc'] = 'آدرس اینستاگرام خود را وارد کنید';
$string['whatsapp'] = 'شماره واتس آپ';
$string['whatsappdesc'] = 'شماره واتس آپ خود را وارد کنید';
$string['topfooterimg'] = 'عکس پاورقی';
...
$string['disablebottomfooter'] = 'غیرفعال سازی پاورقی پایین صفحه';
$string['disablebottomfooterdesc'] = 'غیر فعالسازی نوار نارنجی پایین صفحه';
...
$string['subtitleallcertificates'] = 'گواهینامه ها از تمام درس ها';
$string['subtitlecoursecertificates'] = 'گواهینامه های درس ها';
$string['nohavecertificates'] = 'شما هنوز گواهینامه ای دریافت نکرده اید';
$string['coursesections'] = 'بخش درس ها';

// Mypublic page.
$string['userprofile'] = 'پروفایل کاربری';
$string['competencyplans'] = 'برنامه های شایستگی ها';
$string['details'] = 'جزییات';
$string['startedon'] = 'آغاز شده در';
$string['addcontact'] = 'اضافه کردن مخاطب';
$string['removecontact'] = 'حذف کردن مخاطب';
$string['certificates'] = 'گواهی ها';

// Theme settings.
$string['themesettingstitle'] = 'تنظیمات دسترسی ها';
$string['themesettingsfonttype'] = 'نوع فونت';
$string['themesettingsdefaultfont'] = 'فونت پیشفرض';
$string['themesettingsdyslexicfont'] = 'Dyslexic font';
$string['themesettingsenableaccessibilitytoolbar'] = 'فعالسازی نوار دسترسی ها';
$string['themesettinggsavedsuccessfully'] = 'تنظیمات دسترسی ها با موفقیت ذخیره شد';

// Accessibility features.
$string['accessibilityfontsize'] = 'سایز فونت';
$string['accessibilitydecreasefont'] = 'کاهش سایز فونت';
$string['accessibilityresetfont'] = 'تنظیم مجدد';
$string['accessibilityincreasefont'] = 'افزایش سایز فونت';
$string['accessibilitysitecolor'] = 'رنگ سایت';
$string['accessibilityresetsitecolor'] = 'تنظیم مجدد رنگ سایت';
$string['accessibilitysitecolor2'] = 'کنتراست پایین';
$string['accessibilitysitecolor3'] = 'کنتراست بالا';
